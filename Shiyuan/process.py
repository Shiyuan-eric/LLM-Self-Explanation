...
class GPT_Evaluator():
    ...
    def process_GPT_input_Shiyuan(self):
        ...
        self.explanations = []
        for i in range(100):
            self.explanations.append(self.convert_from_Shiyuan_format(responses["saliency list"][i], responses["sentence"][i]))
        print(self.explanations[0])
...
if __name__ == "__main__":
    response_filename = "PE_Result_GPT4"
    ...
    evaluator.process_GPT_input_Shiyuan()
