...
for i in tqdm(range(num_examples)):
    ...
    responses[sentences[i]] = parse_topk(
        completion.choices[0].message.content, k, sentences[i])
    messages.pop()
    messages.pop()
